					...
					<div class="col-md-9">						
						<div class="row">
								...
								<div class="card bg-white mb-3">
								  <div class="card-header bg-primary">
								  	<div class="d-flex justify-content-between">
								  		...
								  		<a class="font-18 text-secondary" href="{{route('products.index')}}"><i class="fas fa-ellipsis-v"></i></a>
								  	</div>
								  </div>
								  <div class="card-body">
								  	<div class="top-info">
								  		<div class="row">
								  			<div class="col-md-4">
								  				...
								  				<h2 class="font-18">${{number_format((float)$revenue, 2, '.', '')}}</h2>
								  			</div>
								  			<div class="col-md-4">
								  				<p class="font-12 mb-1 text-muted">This Week</p>
								  				<h2 class="font-18">${{number_format((float)$revenue_week, 2, '.', '')}}</h2>
								  			</div>
								  			<div class="col-md-4">
								  				<p class="font-12 mb-1 text-muted">This Month</p>
								  				<h2 class="font-18">${{number_format((float)$revenue_month, 2, '.', '')}}</h2>
								  			</div>
								  		</div>
								  	</div>
								  				...
								  				<div class="row">
								  					<div class="col-6 py-2">
									  					<div class="product-info-1 pl-2">
														      ...
														      <h4 class="font-18 text-primary">{{$lims_supplier_all}}</h4>
									  					</div>
									  				</div>
								  					<div class="col-6 py-2">
								  					...
								  					<div class="col-6 py-2">
									  					<div class="product-info-3 pl-2">
														    ...
														    <h4 class="font-18 text-danger">{{$pending_status}}</h4>
									  					</div>
									  				</div>
								  					<div class="col-6 py-2">
								...
								<div class="card bg-white mb-3">
								  <div class="card-header bg-primary">
								  	<div class="d-flex justify-content-between">
								  		...
								  		<a class="font-18 text-secondary" href="{{route('sales.index')}}"><i class="fas fa-ellipsis-v"></i></a>
								  	</div>
								  </div>
								  <div class="card-body">
                            ...
                            <?php   $customer = DB::table('customers')->find($sale->customer_id); ?>
								  		<div class="d-flex justify-content-between">
											  <h2 class="font-12">{{$customer->name}}</h2>
								...
								<div class="card bg-white mb-3">
								  <div class="card-header bg-primary">
								  	<div class="d-flex justify-content-between">
								  		...
								  		<a class="font-18 text-secondary" href="{{route('category.index')}}"><i class="fas fa-ellipsis-v"></i></a>
								  	</div>
								  </div>
								  <div class="card-body">
								  		<div class="chart">
                  ...
                  <canvas id="saleChart" data-sale_chart_value = "{{json_encode($yearly_sale_amount)}}" data-purchase_chart_value = "{{json_encode($yearly_purchase_amount)}}" data-label1="{{trans('file.Purchased Amount')}}" data-label2="{{trans('file.Sold Amount')}}"></canvas>
							...
							{{-- <div class="col-12">
								<div class="card bg-white mb-3">
								  <div class="card-header bg-primary">
								  	<div class="d-flex justify-content-between">
								  		<h5 class="text-white">Sale Forcast</h5>
								  		<a class="font-18 text-secondary" href="#"><i class="fas fa-ellipsis-v"></i></a>
								  	</div>
								  </div>
								  <div class="card-body">
								  	<div class="row">
								  		<div class="col-md-3 mt-2">
								  			<div class="bg-secondary rounded py-2 px-5 text-center">
									  			<p class="font-14 mb-0">Sales</p>
									  			<h2 class="text-primary font-18">${{number_format((float)$revenue_week, 2, '.', '')}}</h2>
									  		</div>
								  		</div>
								  		<div class="col-md-3 mt-2">
								  			<div class="bg-secondary rounded py-2 px-5 text-center">
									  			<p class="font-14 mb-0">Earned</p>
									  			<h2 class="text-primary font-18">${{number_format((float)$week_profit, 2, '.', '')}}</h2>
									  		</div>
								  		</div>
								  		<div class="col-md-3 mt-2">
								  			<div class="bg-secondary rounded py-2 px-5 text-center">
									  			<p class="font-14 mb-0">Margin</p>
									  			<h2 class="text-primary font-18">$300K</h2>
									  		</div>
								  		</div>
								  		<div class="col-md-3 mt-2">
								  			<div class="bg-secondary rounded py-2 px-5 text-center">
								  	...
								  	<div class="chart">
								  		<canvas id="saleForcast" width="500" height="180"></canvas>
								  	</div>		
								  </div>
								</div>
							</div> --}}
