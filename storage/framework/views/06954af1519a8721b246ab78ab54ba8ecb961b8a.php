                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone_number" value="<?php echo e($lims_supplier_data->phone_number); ?>"  class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.Address')); ?> </label>
                                    <input type="text" name="address" value="<?php echo e($lims_supplier_data->address); ?>"  class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(trans('file.City')); ?> </label>
                                    <input type="text" name="city"  value="<?php echo e($lims_supplier_data->city); ?>"  class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
